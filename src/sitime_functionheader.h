...
static int  clkout_set_frequency(struct drv_si9531x *, int,int, unsigned int);
static int  clkin_set_frequency(struct drv_si9531x *, int, unsigned int, unsigned int);
static int  clkout_enable_disable(struct drv_si9531x *, int, bool);
...
static bool clkout_is_enable_disable(struct drv_si9531x *, int, bool, unsigned int*);
...
static int clkout_set_linktype(struct drv_si9531x *, int, const struct outclk_linkcfg*);
static int set_outputlinktype(struct drv_si9531x *, int, unsigned int);
static int set_differential_mode(struct drv_si9531x *, int,unsigned int,unsigned int);
static int set_swing_voltage(struct drv_si9531x *, int, unsigned int);

static int write_outclk_pll_bits(struct i2c_client *, unsigned int , u8, u8);

/*................. Config Device Settings......................*/
static int write_default_configuration(const struct siT9531x_device *);
